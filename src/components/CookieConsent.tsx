...
export const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-navy dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 shadow-lg z-50">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
          <div className="flex-1 pr-4">
            ...
            <p className="text-sm text-white mb-4 md:mb-0">
              ...
              <Link to="/regulations" className="text-white underline">
          ...
          <div className="flex space-x-2">
            <Button 
              variant="outline" 
              size="sm" 
              className="text-sm text-white border-white hover:bg-white/10" 
            ...
            <Button 
              variant="default" 
              size="sm" 
              className="text-sm bg-white text-navy hover:bg-white/90" 
